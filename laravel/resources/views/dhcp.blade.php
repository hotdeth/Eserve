...
>>>>>>> b0640ebf3a66442deb93effaaefb09cd08b5feb7
...
=======
      ...
      <label>
        ...
        <span style="transition-delay: 300ms;">k</span>
    ...
    <input type="text" required=" ">
        <label>
          ...
          <span style="transition-delay: 350ms;"> </span>
            ...
            <span style="transition-delay: 550ms;">t</span>
        ...
        <div class="op-subnetmask">
          ...
          <label>
            ...
            <span style="transition-delay: 800ms;">a</span>
            <span style="transition-delay: 850ms;">s</span>
            <span style="transition-delay: 900ms;">k</span>
            <span style="transition-delay: 950ms;">:</span>
          </label>
    </div>
